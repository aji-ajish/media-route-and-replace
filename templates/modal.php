	...
	<div class="wpmm-modal__dialog">
		...
		<div class="wpmm-modal__header">
			<h2 class="wpmm-modal__title" id="wpmm-modal-title">
				<?php esc_html_e( 'Add Media Entry', 'wp-media-manager' ); ?>
			</h2>
			<button type="button" class="wpmm-modal__close" aria-label="<?php esc_attr_e( 'Close', 'wp-media-manager' ); ?>">
		...
		<div class="wpmm-modal__body">
			...
			<div class="wpmm-form-section">
				<h3 class="wpmm-form-section__heading">
					...
					<?php esc_html_e( 'Media File', 'wp-media-manager' ); ?>
				</h3>
				...
				<div class="wpmm-media-selector">
					...
					<div id="wpmm-media-preview" class="wpmm-media-preview wpmm-media-preview--empty">
						...
						<span class="wpmm-media-preview__placeholder-text">
							<?php esc_html_e( 'No file selected', 'wp-media-manager' ); ?>
						</span>
					</div>
					...
					<div class="wpmm-media-selector__actions">
						<button type="button" class="wpmm-btn wpmm-btn--secondary" id="wpmm-open-media-library">
							<span class="dashicons dashicons-admin-media" aria-hidden="true"></span>
							<?php esc_html_e( 'Choose from Media Library', 'wp-media-manager' ); ?>
						</button>

						<span class="wpmm-or-divider"><?php esc_html_e( 'or paste URL', 'wp-media-manager' ); ?></span>
						...
						<div class="wpmm-url-input-wrap">
							<input
								...
								id="wpmm-url-input"
								class="wpmm-input"
								placeholder="<?php esc_attr_e( 'https://yoursite.com/wp-content/uploads/…', 'wp-media-manager' ); ?>"
								autocomplete="off"
							/>
							<button type="button" class="wpmm-btn wpmm-btn--secondary wpmm-btn--icon" id="wpmm-resolve-url" title="<?php esc_attr_e( 'Detect attachment', 'wp-media-manager' ); ?>">
				...
				<div id="wpmm-selected-info" class="wpmm-selected-info" hidden>
					...
					<button type="button" class="wpmm-selected-info__clear" id="wpmm-clear-media" title="<?php esc_attr_e( 'Clear selection', 'wp-media-manager' ); ?>">
						<span class="dashicons dashicons-no-alt" aria-hidden="true"></span>
					</button>
				</div>
			</div>
			...
			<div class="wpmm-form-section">
				<h3 class="wpmm-form-section__heading">
					...
					<?php esc_html_e( 'Custom Settings', 'wp-media-manager' ); ?>
				</h3>

				<div class="wpmm-form-row">
					<label class="wpmm-label" for="wpmm-custom-name">
						<?php esc_html_e( 'Custom Name', 'wp-media-manager' ); ?>
						<span class="wpmm-label__hint"><?php esc_html_e( '(without extension)', 'wp-media-manager' ); ?></span>
					</label>
					<input
						type="text"
						id="wpmm-custom-name"
						class="wpmm-input"
						placeholder="<?php esc_attr_e( 'e.g. my-annual-report', 'wp-media-manager' ); ?>"
						autocomplete="off"
					/>
				</div>
				...
				<div class="wpmm-form-row">
					<label class="wpmm-label" for="wpmm-custom-path">
						<?php esc_html_e( 'Custom Path', 'wp-media-manager' ); ?>
						<span class="wpmm-label__hint"><?php esc_html_e( '(relative, no leading slash)', 'wp-media-manager' ); ?></span>
					</label>
					<input
						type="text"
						id="wpmm-custom-path"
						class="wpmm-input"
						placeholder="<?php esc_attr_e( 'e.g. reports/2025', 'wp-media-manager' ); ?>"
						autocomplete="off"
					/>
				</div>
				...
				<div class="wpmm-form-row wpmm-form-row--toggle">
					<label class="wpmm-toggle" for="wpmm-include-ext">
						...
						<span class="wpmm-toggle__label"><?php esc_html_e( 'Include file extension', 'wp-media-manager' ); ?></span>
					</label>
				</div>

				<!-- Live output preview -->
				<div class="wpmm-output-preview">
					<span class="wpmm-output-preview__label"><?php esc_html_e( 'Preview:', 'wp-media-manager' ); ?></span>
		...
		<div class="wpmm-modal__footer">
			<button type="button" class="wpmm-btn wpmm-btn--ghost" id="wpmm-modal-cancel">
				<?php esc_html_e( 'Cancel', 'wp-media-manager' ); ?>
			</button>
			<button type="button" class="wpmm-btn wpmm-btn--primary" id="wpmm-modal-save">
				...
				<span class="wpmm-btn__label"><?php esc_html_e( 'Save Entry', 'wp-media-manager' ); ?></span>
			</button>
		</div>
