...
<div class="wrap wpmm-wrap">
	...
	<div class="wpmm-toolbar">
		<div class="wpmm-search">
			...
			<input type="search" id="wpmm-search" class="wpmm-search__input"
				placeholder="<?php esc_attr_e('Search by name, path, or type…', 'media-route-and-replace'); ?>"
				autocomplete="off" />
		</div>
	...
	<div id="wpmm-table-wrap" class="wpmm-table-wrap">
		<div id="wpmm-loading" class="wpmm-loading">
			...
			<span><?php esc_html_e('Loading entries…', 'media-route-and-replace'); ?></span>
		</div>

		<div id="wpmm-empty" class="wpmm-empty" hidden>
			<span class="dashicons dashicons-portfolio wpmm-empty__icon"></span>
			<h3 class="wpmm-empty__title"><?php esc_html_e('No entries yet', 'media-route-and-replace'); ?></h3>
			<p class="wpmm-empty__desc"><?php esc_html_e('Click "Add New" to add your first media entry.', 'media-route-and-replace'); ?></p>
			<button type="button" class="wpmm-btn wpmm-btn--primary" id="wpmm-add-new-empty">
				<span class="dashicons dashicons-plus-alt2"></span>
				<?php esc_html_e('Add New Entry', 'media-route-and-replace'); ?>
			</button>
		</div>
	...
	<div id="wpmm-replace-modal" class="wpmm-modal" role="dialog" aria-modal="true" aria-labelledby="wpmm-replace-modal-title" style="z-index: 999999;" hidden>
		...
		<div class="wpmm-modal__dialog" style="max-width: 750px; z-index: 999999; background: #fff; border-radius: 8px; overflow: hidden; position: relative;">
			...
			<div class="wpmm-modal__header">
				<h2 class="wpmm-modal__title" id="wpmm-replace-modal-title"><?php esc_html_e('Select New Replacement Media', 'media-route-and-replace'); ?></h2>
			...
			<div class="wpmm-modal__body" style="padding: 20px; max-height: 80vh; overflow-y: auto;">
				...
				<div class="wpmm-form-row" style="display: flex; gap: 20px; align-items: center; background: #f3f4f6; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
					<div style="flex: 1; text-align: center;">
						<strong style="display:block; margin-bottom: 8px; color:#4b5563; font-size:12px;"><?php esc_html_e('Current Media', 'media-route-and-replace'); ?></strong>
					...
					<div style="flex: 1; text-align: center;">
						<strong style="display:block; margin-bottom: 8px; color:#4b5563; font-size:12px;"><?php esc_html_e('New Media', 'media-route-and-replace'); ?></strong>
				...
				<div style="display: flex; gap: 20px;">
					<div style="flex: 1; background: #f9fafb; padding: 15px; border-radius: 6px; border: 1px solid #e5e7eb;">
						<h3 style="margin-top:0; font-size:14px; border-bottom:1px solid #e5e7eb; padding-bottom:8px; color:#111827;"><?php esc_html_e('Replacement Options', 'media-route-and-replace'); ?></h3>
						...
						<label style="display:block; margin-bottom:10px; font-weight:600; color:#111827; cursor:pointer;">
							...
							<?php esc_html_e('Just replace the file', 'media-route-and-replace'); ?>
						</label>
						<p style="font-size:11px; color:#6b7280; margin-left:20px; margin-top:-5px; line-height:1.4;">
							<?php esc_html_e('The file name will remain the same regardless of what file you upload, and it will be saved in the exact same URL path.', 'media-route-and-replace'); ?>
						</p>
						...
						<label style="display:block; margin-top:20px; margin-bottom:10px; font-weight:600; color:#111827; cursor:pointer;">
							...
							<?php esc_html_e('Replace the file, use the new file name, and update all links', 'media-route-and-replace'); ?>
						</label>
						<p style="font-size:11px; color:#6b7280; margin-left:20px; margin-top:-5px; line-height:1.4;">
							<?php esc_html_e('The original name of the new file will be used, and all custom manager links mapped to this media will be updated automatically.', 'media-route-and-replace'); ?>
						</p>
					</div>

					<div style="flex: 1; background: #f9fafb; padding: 15px; border-radius: 6px; border: 1px solid #e5e7eb;">
						<h3 style="margin-top:0; font-size:14px; border-bottom:1px solid #e5e7eb; padding-bottom:8px; color:#111827;"><?php esc_html_e('Options', 'media-route-and-replace'); ?></h3>
						<p style="font-size:11px; font-weight:600; color:#4b5563; margin-bottom:10px;"><?php esc_html_e('When replacing the media, do you want to:', 'media-route-and-replace'); ?></p>
						...
						<label style="display:block; margin-bottom:10px; font-weight:normal; color:#111827; cursor:pointer;">
							...
							<?php esc_html_e('Replace the date with the current date', 'media-route-and-replace'); ?>
						...
						<label style="display:block; margin-bottom:10px; font-weight:normal; color:#111827; cursor:pointer;">
							...
							<?php esc_html_e('Keep the date', 'media-route-and-replace'); ?>
			...
			<div class="wpmm-modal__footer" style="padding:15px 20px; background:#f9fafb; display:flex; justify-content:flex-end; gap:10px; border-top:1px solid #e5e7eb;">
				<button type="button" class="wpmm-btn wpmm-btn--ghost" id="wpmm-replace-modal-cancel"><?php esc_html_e('Cancel', 'media-route-and-replace'); ?></button>
				<button type="button" class="wpmm-btn wpmm-btn--primary" id="wpmm-replace-modal-submit" disabled>
					...
					<span class="wpmm-btn__label"><?php esc_html_e('Upload', 'media-route-and-replace'); ?></span>
				</button>
			</div>
		</div>
	</div>
